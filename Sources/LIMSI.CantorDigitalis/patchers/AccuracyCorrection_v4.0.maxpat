...
,
					"patching_rect" : [ 15.0, 2.5, 96.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.166718, 574.0, 107.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 107.912537, 77.0, 158.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 873.0, 20.0, 68.0 ],
					"text" : "P\nI\nT\nC\nH",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 565.5, 20.0, 68.0 ],
					"text" : "P\nI\nT\nC\nH",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 409.5, 21.0, 80.0 ],
					"text" : "T\nA\nR\nG\nE\nT",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.840454, 80.912537, 22.0, 203.0 ],
					"text" : "T\nR\nI\nG\nG\nE\nR\n\nA\nU\nT\nO\nT\nU\nN\nE",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 873.0, 21.035309, 68.0 ],
					"text" : "T\nU\nN\nE\nR",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 848.5, 21.0, 117.0 ],
					"text" : "F\nR\nE\nQ\nU\nE\nN\nC\nY",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.161438, 72.0, 21.0, 215.0 ],
					"text" : "I\nM\nP\nO\nR\nT\n\nM\nI\nD\nI\n\nP\nI\nT\nC\nH",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"range" : 128,
					"size" : 128,
					"table_data" : [ 0, 0, 3, 6, 10, 12, 15, 18, 21, 23, 25, 28, 30, 32, 34, 36, 38, 40, 42, 43, 45, 47, 48, 50, 51, 53, 54, 56, 57, 58, 60, 61, 62, 64, 65, 66, 67, 68, 69, 70, 71, 72, 74, 75, 76, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 85, 86, 87, 88, 89, 89, 90, 91, 92, 93, 93, 94, 95, 95, 96, 97, 97, 98, 99, 99, 100, 101, 101, 102, 103, 103, 104, 104, 105, 106, 106, 107, 107, 108, 109, 109, 110, 110, 111, 111, 112, 112, 113, 113, 114, 114, 115, 115, 116, 116, 117, 117, 118, 118, 119, 119, 120, 120, 121, 121, 122, 122, 122, 123, 123, 124, 124, 125, 125, 125, 126, 126, 127, 127 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 405.0, 28.0, 389.0 ],
					"text" : "A\nC\nC\nU\nR\nA\nC\nY\n\nC\nO\nR\nR\nE\nC\nT\nI\nO\nN"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 397.5, 125.205383, 38.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 213.200531, 813.5, 228.691254, 813.5, 228.691254, 716.0, 242.181976, 716.0 ],
					"source" : [ "obj-118", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/lionel/Lionoil/Recherche/Synthese/Objets_Max/abstractions_cantor_digitartic_digitartic/OlivierPerrotin",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
